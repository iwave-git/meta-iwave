...
KERNEL_BRANCH ?= "iwave_5.4.24_2.1.0-iwg27s-r2.0-rel0.1"
LOCALVERSION = "-2.1.0"
KERNEL_SRC ?= "git://github.com/iwave-git/linux-imx-iWave.git;protocol=https"
SRC_URI = "${KERNEL_SRC};branch=${KERNEL_BRANCH} "

SRCREV = "cb6a5a75a669aa701fa465bdcbd65d9c9092dc37"
...
do_copy_defconfig () {
    ...
    if [ ${DO_CONFIG_V7_COPY} = "yes" ]; then
        ...
        mkdir -p ${B}
        cp ${S}/arch/arm64/configs/iw_rainbowg27s_defconfig ${B}/.config
        cp ${S}/arch/arm64/configs/iw_rainbowg27s_defconfig ${B}/../defconfig
    fi
}
