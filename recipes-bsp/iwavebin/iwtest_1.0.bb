...
SRC_URI = "file://GPL-2 file://tfr.mp4 file://iwg40m_hello_world.bin file://iwg40m_rpmsg_lite_pingpong_rtos_linux_remote.bin file://iwg40m_rpmsg_lite_str_echo_rtos.bin"
FILES_${PN} = "iwtest "
S = "${WORKDIR}"
